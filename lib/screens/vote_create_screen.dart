// lib/screens/vote_create_screen.dart
import 'package:flutter/material.dart';
import 'package:intl/intl.dart';
import '../services/vote_service.dart';
import '../models/vote_model.dart';

class VoteCreateScreen extends StatefulWidget {
  const VoteCreateScreen({super.key});

  @override
  State<VoteCreateScreen> createState() => _VoteCreateScreenState();
}

class _VoteCreateScreenState extends State<VoteCreateScreen> {
  ...
  TimeOfDay _timeDebut = const TimeOfDay(hour: 8, minute: 0);
  TimeOfDay _timeFin = const TimeOfDay(hour: 18, minute: 0);
  ...
  Future<void> _submitVote() async {
    ...
    try {
      ...
      await _service.createVote(vote);

      setState(() => _isLoading = false);

      if (mounted) {
        _showSnackBar('✅ Vote créé avec succès', Colors.green);
